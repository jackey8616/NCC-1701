var user = new User(1.496e8, 0, 1500, 300, 4);
var solar_system = {
	planet:[
		new Planet(0, "Sun", 1.989e30, 0, 0, 6.955e5, 0, 0, "ORANGE"),
		new Planet(1, "Mercury", 3.3e23, 5.79e7, 0, 2.4395e3, 0, 47.4, "#E0FFFF"),
		new Planet(2, "Venus", 4.87e24, 1.082e8, 0, 6.052e3, 0, 35, "#CD7F32"),
		new Planet(3, "Moon", 7.36e22, 1.496e8+3.844e5, 0, 1.737e3, 0, -(-29.78567831-1.02396911), "WHITE"),
		new Planet(4, "Earth", 5.972e24, 1.496e8, 0, 6.371e3, 0, 29.78567831, "BLUE"),
